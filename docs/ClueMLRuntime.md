...
## Purpose
This document describes the shipped OpenAI seat runtime in **v1.7.5**. It is for the maintainer changing prompts, profiles, tools, tracing, fallback behavior, or social-memory integration without breaking Clue's deterministic gameplay guarantees.
