...
This module centralizes the environment contract for the v1.7.2 seat runtime.
...
def load_llm_runtime_config() -> LLMRuntimeConfig:
    """Load and cache the normalized v1.7.2 LLM runtime configuration.
    ...
    keep app config, tests, and maintainer docs aligned.
    """
